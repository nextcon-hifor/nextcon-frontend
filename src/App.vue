                ...
                <header class="header">
                    ...
                    <nav class="nav-links">
                        <ul>
                            ...
                            <li class="li-text-op1">
                                <router-link to="/fnq">Help</router-link>
                            </li>
                            <!-- <li class="li-text-op1"><router-link to="/notice">Blogs</router-link></li> -->
                            <li class="li-btn-op1" v-if="isLoggedIn">
            ...
            <div class="row footer-space">
                ...
                <div class="col-12">
                    ...
                    <div class="button-row">
                        ...
                        <button class="cta-button secondary-button wc-btn">
                            <router-link to="/allEvents"
                ...
                <div class="follow-us">
                    ...
                    <div class="row follow-row">
                        ...
                        <a class="follow-kakao" href="https://open.kakao.com/">
                            <img src="/assets/img/icon_KakaoTalk.png" alt="" />
                            KakaoTalk
                        </a>
                    </div>
                </div>
                    ...
                    <div class="row newsletter-box">
                        <div class="col-6 newsletter-content">
                            <div class="newsletter-icon">
                                <img
                                    src="/assets/img/icon_SendMail.png"
                                    alt=""
                                />
                            </div>
                            <div>
                                ...
                                <p class="newsletter-description">
                                    Receive the latest updates and exclusive
                                    benefits. <br />
    ...
    <div class="Mobile" id="app">
        <header class="header">
            ...
            <div class="mobile-menu" :class="{ active: isMenuOpen }">
                ...
                <ul>
                    ...
                    <li>
                        <router-link to="/allEvents" @click="toggleMenu"
                            >All Events</router-link
                        >
                    </li>
                    <li>
                        <router-link to="/fnq" @click="toggleMenu"
                            >Help</router-link
                        >
                    </li>
                    <!-- <li><router-link to="/notice" @click="toggleMenu">Blogs</router-link></li> -->
                    <li class="li-btn-op1" v-if="!isLoggedIn">
                        <router-link to="/logIn">SignIn / SignUp</router-link>
                    </li>
                    <!-- 로그인 시 -->
                    <li class="li-btn-op1" v-if="isLoggedIn">
                        <router-link to="/postEvent">Create Event</router-link>
                    </li>
                    <li class="li-btn-op1" v-if="isLoggedIn">
                        <router-link to="/chat">Chatting</router-link>
                    </li>
                    <li class="li-btn-op1" v-if="isLoggedIn">
        ...
        <div class="row footer-space">
            ...
            <div class="allevent-button-box">
                <router-link class="allevent-button" to="/allEvents"
                    >Browse Events</router-link
                >
            </div>
                ...
                <div class="row newsletter-box">
                    <div class="col-12 newsletter-input-container">
                        ...
                        <input
                            ...
                            placeholder="Enter your email..."
                        />
                        <button class="newsletter-button" @click="subscribe">
                            Subscribe
                        </button>
                    </div>
                </div>

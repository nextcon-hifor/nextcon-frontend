            ...
            <form @submit.prevent="handleRegister">
                ...
                <div class="form-group">
                    <div class="row half-input-row">
                        <div class="col-6 email-box">
                            ...
                            <input type="email" v-model="user.email" @input="checkEmailAvailability" placeholder="Email"
                                required />
                        </div>
                ...
                <div class="form-group" v-if="showVerificationInput">
                    <div class="row half-input-row">
                        ...
                        <div class="col-6 code-btn-box">
                            <button v-if="!isVerified" class="code-btn" type="button"
                ...
                <div class="form-group">
                    ...
                    <input type="id" id="id" placeholder="Your ID" v-model="user.userId"
                        @input="checkUserIdAvailability" required />
                </div>
                ...
                <div class="form-group password-group">
                    <div class="row half-input-row">
                        ...
                        <div class="col-6">
                            ...
                            <input type="password" v-model="user.confirmPassword" id="password" placeholder="Password"
                                required />
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" v-model="searchQuery" @focus="showDropdown = true" @blur="hideDropdown"
                            @input="filterCountries" placeholder="Search for a country..." class="search-input"
                            required />
                        <!-- 드롭다운 -->
